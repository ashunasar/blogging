...
if(isset($_POST['signup'])){
    ...
    $query  = "Insert Into user(user_username,user_name,user_email,user_phone,user_pass,user_img,user_role) " ;
    $query .= "Values ('{$username}','{$name}','{$email}','{$mobile_number}','{$pass}','{$path}','{$user_role}')";
