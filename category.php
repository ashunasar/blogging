<?php  include "includes/header.php"?> 
	...
	<div id="colorlib-page">
		...
		<div id="colorlib-main">
            ...
            $post_query_count  = "SELECT * FROM post where post_category_id='{$category}' and post_status ='published'";
            ...
            $count_row = ceil($count_row/5);
              ...
              <?php 
                            ?>
        <?php 
          $query  = "SELECT * FROM post where post_category_id='{$category}' ORDER by post_id DESC LIMIT $page_1,5";
                  ...
                  <?php include "post_contain.php"?>
                    ...
                    if($i == $page){
                    echo "<li class='active'><a style='border: none;'href='category.php?page={$i}&category={$category}'><span>{$i}</span></a></li>";
                    }
                    else{
                    echo "<li><a style='border: none;' href='category.php?page={$i}&category={$category}'><span>{$i}</span></a></li>";
                    }
                    } 
                              ?>
			              </ul>
