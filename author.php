<?php  include "includes/header.php"?> 
	...
	<div id="colorlib-page">
        ...
        <?php 
          $query  = "SELECT * FROM post where post_author='{$author}' and post_status ='published' ORDER by post_id DESC LIMIT $page_1,5";
                    ...
                    if($i == $page){
                    echo "<li class='active'><a style='border: none;' href='author.php?page={$i}&author={$author}'><span>{$i}</span></a></li>";
                    }
                    else{
                    echo "<li><a style='border: none;' href='author.php?page={$i}&author={$author}'><span>{$i}</span></a></li>";
                    }
                    } 
                              ?>
			              </ul>
